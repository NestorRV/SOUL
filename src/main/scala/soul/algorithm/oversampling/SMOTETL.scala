...
/** SMOTETL algorithm. Original paper: "A Study of the Behavior of Several Methods for Balancing Machine Learning
  ...
  */
class SMOTETL(private[soul] val data: Data, private[soul] val seed: Long = System.currentTimeMillis(), percent: Int = 500,
              k: Int = 5, dist: DistanceType = Distance(euclideanDistance), val normalize: Boolean = false, val verbose: Boolean = false) {
